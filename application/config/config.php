 ...
 */
$sub_base_url = rtrim(str_replace('collaborland.kr','',$_SERVER['SERVER_NAME']),'.');
$config['base_url'] = ($sub_base_url == '')? 'https://collaborland.kr' : "https://{$sub_base_url}.collaborland.kr";
 ...
 */
$config['encryption_key'] = '98959bB2082e1b200d!$%7752447CM1c4';
...
//$config['sess_match_ip'] = FALSE; 이게 기본인데 중복 방지
...
$config['cookie_domain'] = '.collaborland.kr'; // .ciboard.co.kr 와 같이 맨 앞에 . 을 찍고 도메인 명을 적습니다
$config['cookie_path'] = '/';
