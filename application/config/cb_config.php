...
$config['install_ip'] = '58.226.22.41'; // 여기에 all 이라고 적으면, 모든 IP 에서 접근 가능합니다, 간혹 localhost 에 설치할 때에 ip 체크를 제대로 하지 못한 경우를 대비합니다.
...
$config['email_protocal'] = 'mail'; // mail/sendmail/smtp
$config['email_smtp_host'] = 'mail5.domainclub.kr';
$config['email_smtp_user'] = 'cs@collaborland.kr';
$config['email_smtp_pass'] = 'teammeta00!';
$config['email_smtp_port'] = '25';
$config['email_smtp_crypto'] = 'null'; // SMTP Encryption. Can be null, tls or ssl.
