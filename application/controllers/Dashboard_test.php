 ...
 */
class Dashboard_test extends CB_Controller
{
				...
				foreach($view['view']['data']['ranking']['list'] as $k => $v){
					...
					if($v['mem_id'] == $this->member->item('mem_id')){
						...
						if($k >= 0 && $k <= 2){ // 위에서 3등 안에 있을 경우
							...
							// $view['view']['data']['ranking']['mylist'][3]['num'] = $k+2;
							$view['view']['data']['ranking']['mylist'][4] = $view['view']['data']['ranking']['list'][$k+2];
							// $view['view']['data']['ranking']['mylist'][4]['num'] = $k+3;
							...
							// $view['view']['data']['ranking']['mylist'][4]['num'] = $rankingListCount; // 마지막 항목에 랭킹이 담기지않아서 추가	
						}
