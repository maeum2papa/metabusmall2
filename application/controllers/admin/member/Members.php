...
class Members extends CB_Controller
{
	...
	public function index()
	{
		...
		$mem_useYn = $this->{$this->modelname}
			->get_yn_list($per_page, $offset, $where, '', $findex, $forder, $sfield, $skeyword);
		...
		$view['view']['useYn'] = $mem_useYn['total_rows'];
		//debug($view['view']['data']);
		...
		$view['view']['list_yn_url'] = admin_url($this->pagedir . '/listyn/?' . $param->output());
