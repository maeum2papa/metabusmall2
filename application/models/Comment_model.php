...
class Comment_model extends CB_Model
{
	...
	public function get_comment_list($limit = '', $offset = '', $where = '', $like = '', $orderby = '', $sfield = '', $skeyword = '', $sop = 'OR')
	{
		...
		$this->db->select('comment.*, company_info.company_name, member.mem_div, member.mem_position, member.company_idx, member.mem_id, member.mem_userid, member.mem_nickname, member.mem_icon, member.mem_photo, member.mem_point');
