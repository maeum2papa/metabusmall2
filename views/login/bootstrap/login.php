	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="asmo_guest_login">
				<span>초대코드를 발급 받으셨나요?</span>
				<a href="" title="게스트 로그인">게스트 입장 ></a>
			</div>
			...
			?>
				...
				<div class="form-group">
					...
					<div class="col-lg-7">
						...
						<!-- asmo sh 231113 디자인 상 input에 placeholder 추가 -->
						<input type="text" name="mem_userid" class="form-control" value="<?php echo set_value('mem_userid'); ?>" accesskey="L" placeholder="이메일 입력" />
						<!-- //asmo sh 231113 디자인 상 input에 placeholder 추가 -->
				...
				<div class="form-group password_form">
					...
					<div class="col-lg-7">
						...
						<!-- asmo sh 231113 디자인 상 input에 placeholder 추가 -->
						<input type="password" class="form-control" name="mem_password" placeholder="패스워드 입력" />
						<!-- //asmo sh 231113 디자인 상 input에 placeholder 추가 -->
