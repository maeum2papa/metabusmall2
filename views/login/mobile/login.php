...
<div class="access">
	<div class="table-box">
		<div class="table-heading"><img src="<?php echo element('layout_skin_url', $layout); ?>/images/login_logo.svg" alt=""></div>
		<div class="table-body">
			...
			?>
				...
				<ol class="loginform">
					<li>
						<span style="display:none;"><?php echo element('userid_label_text', $view);?></span>
						<input placeholder="이메일 입력" type="text" name="mem_userid" class="input" value="<?php echo set_value('mem_userid'); ?>" accesskey="L" />
					</li>
					<li>
						<!-- <span>비밀번호</span> -->
						<input type="password" placeholder="패스워드 입력" class="input" name="mem_password" />
					</li>
					<li class="asmo_login_btn_li">
						<button type="submit" class="btn btn-primary btn-sm" id="asmo_login_btn">컬래버랜드 접속</button>
						<!-- <label for="autologin">
		...
		<div class="table-footer">
			<a style="display:none;" href="<?php echo site_url('register'); ?>" class="btn btn-success btn-sm" title="회원가입">회원가입</a>
			<a id="asmo_find_pw" href="<?php echo site_url('findaccount'); ?>" class="btn btn-default btn-sm" title="아이디 패스워드 찾기">비밀번호 재설정</a>
		</div>
	</div>
</div>
