	...
	<div class="product-feedback">
		...
		<div class="feedback-box qna-content ">
			...
			<?php if (element('can_update', $result)) { ?>
				...
				<!-- asmo sh 231207 디자인 상 아이콘 display: none 처리 -->
				<a href="javascript:;" class="btn btn-xs btn-default" onClick="window.open('<?php echo site_url('cmall/qna_write/' . element('cit_id', $view) . '/' . element('cqa_id', $result) . '?page=' . $this->input->get('page')); ?>', 'qna_popup', 'width=750,height=770,scrollbars=1'); return false;"><i class="dn fa fa-pencil-square-o" aria-hidden="true"></i> 수정</a>
			<?php } ?>
