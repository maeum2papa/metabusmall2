...
<body style="margin:0px;padding:0px;overflow:hidden">
	...
	<iframe id="game" allow="camera *;microphone *; display-capture *; clipboard-write; autoplay" 
		src="https://collaborland.kr:8000/" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;
