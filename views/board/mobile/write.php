...
<div id="asmo_item_detail_wrap" class="asmo_board_list_wrap asmo_board_write_wrap" >
	<div class="board">
		<h3>1:1문의 글쓰기</h3>
		<?php
		...
		?>
			...
			<li id="asmo_write_tit_li">
				...
				?>
				<div class="asmo_board_write_tit_input_wrap">
					<input type="text" class="input" placeholder="제목을 입력해 주세요." name="post_title" id="post_title" value="<?php echo set_value('post_title', element('post_title', element('post', $view))); ?>" />
				</div>
			...
			?>
				<li class="asmo_upload_file_li">
					<!-- <span>파일 #<?php //echo $i+1; ?></span> -->
					<input type="file" id="asmo_file<?php echo $i+1; ?>" class="input" name="<?php echo $file_column; ?>" onchange="javascript:document.getElementById('asmo_file_label<?php echo $i+1; ?>').innerText = this.value.split('\\')[2]" />
					<label id="asmo_file_label<?php echo $i+1; ?>" for="asmo_file<?php echo $i+1; ?>">파일 업로드하기</label>
