	...
	<div id="comment_write_box">
		<div class="well comment_write_box_inner">
			...
			?>
				...
				<div class="comment_write_button_area">
					<div class="btn-group" role="group" aria-label="...">
						<?php if (element('can_comment_secret', element('comment', $view))) { ?>
							<div class="checkbox asmo_secret_chk">
								<input type="checkbox" name="cmt_secret" id="cmt_secret" value="1" <?php echo set_checkbox('cmt_secret', '1', (element('cmt_secret', element('comment', $view)) ? true : false)); ?> />
				...
				<div class="asmo_comment_input_wrap">
