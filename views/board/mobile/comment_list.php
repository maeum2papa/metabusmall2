...
?>
	<div class="media asmo_<?php echo element('cmt_depth', $result); ?>_depth"  id="comment_<?php echo element('cmt_id', $result); ?>" style="padding-left:<?php echo element('cmt_depth', $result) + 12;  ?>px !important;">
		<?php if (element('use_comment_profile', element('board', $view))) { ?>
			<div class="media-left">
				<img class="media-object member-photo" src="<?php echo element('member_photo_url', $result); ?>" width="64" height="64" alt="<?php echo html_escape(element('cmt_nickname', $result)); ?>" title="<?php echo html_escape(element('cmt_nickname', $result)); ?>" />
			</div>
			...
			<?php
				...
				<span class="reply 222">
					...
					<?php if (element('can_reply', $result)) { ?>
						<a class="asmo_comment_reply_btn" href="javascript:;" onClick="comment_box('<?php echo element('cmt_id', $result); ?>', 'c'); return false;">답변하기</a>
					<?php } ?>
