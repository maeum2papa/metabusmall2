...
<!-- asmo sh 231220 디자인 상 작성자, 관리자일 때 노출되는 div를 .chk_comment_all_wrapper_box로 감싸고 댓글 박스와 자리 바꾸기  -->
	...
	<div id="comment_write_box">
		<div class="well comment_write_box_inner">
			...
			?>
				...
				<!-- asmo sh 231218 비밀글 체크박스 textarea 뒤로 배치 후 주석처리 -->
...
?>
	<div class="chk_comment_all_wrapper_box">
