...
<div class="modal-header">
	...
	<!-- asmo sh 231207 modal-title에 svg 추가 및 텍스트 변경 -->
...
<?php
	...
	?>
		...
		<div class="form-horizontal box-table">
			...
			<?php } ?>
			<!-- 문의유형 피드백으로 고정 start : 지우지마세요 -->
			<div class="form-group" style="display:none;">
				<label class="col-sm-2 control-label" for="qna_type">문의유형</label>
				<div class="col-sm-10">
					<div class="input-group">
						<select name="qna_type" class="form-control input" required="" aria-required="true">
							<option value="피드백" selected>피드백</option> 
						</select>
					</div>
				</div>
			</div>
			<!--// 문의유형 피드백으로 고정 end : 지우지마세요 -->
			...
			<!-- asmo sh 231219 div 클래스 이름 변경 및 라벨 "내용" 추가 및 에디터 버튼 주석 처리 -->
			...
			<div class="border_button text-center mt20">
				...
				<!-- asmo sh 231219 디자인 상 두 버튼 자리 바꿈 -->
