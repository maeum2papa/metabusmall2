		...
		<div class="table-body">
			<div class=" findaccount">
				...
				?>
					...
					<div class="group">
						<input type="email" name="idpw_email" id="idpw_email" class="input" placeholder="이메일 입력" />
						<button class="btn btn-black btn-sm" type="submit" id="asmo_find_pw_btn">ID/PW 찾기</button>
					</div>
				<?php
				...
				if ($this->cbconfig->item('use_register_email_auth')) {
					...
					?>
						...
						<div class="group">
							<input type="email" name="verify_email" id="verify_email" class="input" placeholder="이메일 입력" />
