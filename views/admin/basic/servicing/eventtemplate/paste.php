<div class="box">
    <div class="box-table">
        <?php
            ...
            $attributes = array('class' => 'form-horizontal', 'name' => 'fadminmodify', 'id' => 'fadminmodify', 'onsubmit' => 'return submitContents(this)');
            echo form_open_multipart(admin_url($this->pagedir).'/save'. '?' . $this->input->server('QUERY_STRING', null, ''), $attributes);
        ?>
            <input type="hidden" name="mode" value="register">
            <input type="hidden" name="event_idx" value="<?php echo element('event_idx', $view); ?>" />
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-sm-10 form-inline" colspan="3">
                            <label for="st"><input type="radio" name="event_giveFl" value="st" id="st" <?php if(element('event_giveFl', element('data', $view)) == 'st'){ echo 'checked'; } ?>>시작일 지급</label>
                            <label for="en"><input type="radio" name="event_giveFl" value="en" id="en" <?php if(element('event_giveFl', element('data', $view)) == 'en'){ echo 'checked'; } ?>>종료일 지급</label>
                            <label for="sp"><input type="radio" name="event_giveFl" value="sp" id="sp" <?php if(element('event_giveFl', element('data', $view)) == 'sp'){ echo 'checked'; } ?>>특정일 지급</label>
            ...
            <table class="table table-hover table-striped table-bordered">
                <tbody>
                    <tr>
                        ...
                        <td class="col-sm-10" colspan="3">
                            <?php
                            if(element('event_thumb', element('data', $view)))
                                echo "<img src='".element('event_thumb', element('data', $view))."' style='width:100px;height:auto;'/>";
                            ?>
                            <input type="hidden" name="event_thumb_ori" value="<?php echo element('event_thumb', element('data', $view)); ?>">
