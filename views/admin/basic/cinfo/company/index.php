                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col-sm-4 form-inline">
                            <?php echo element('plan_name', element('data', $view)); ?>
                             / 
                            <?php if(element('plan_type', element('data', $view)) == 'm'){ echo '월간'; } else if(element('plan_type', element('data', $view)) == 'y'){ echo '연간'; } ?>
                        </td>
                        <th class="col-sm-2">상태</th>
                        <td class="col-sm-4 form-inline">
                            <span><?php if(element('state', element('data', $view)) == 'use'){ echo '활성화'; }else{ echo '비활성화'; } ?></span>
                        </td>
                    </tr>
                    <tr>
                        <th class="col-sm-2">이용 가능 인원</th>
                        <td class="col-sm-4 form-inline"><?php echo element('use_cnt', element('data', $view)); ?>명</td>
                    ...
                    <tr>
                        ...
                        <td class="col-sm-4 form-inline"><?php echo element('use_sday', element('data', $view)); ?></td>
                        <th class="col-sm-2">이용종료일</th>
                        <td class="col-sm-4 form-inline"><?php echo element('use_eday', element('data', $view)); ?></td>
                    </tr>
                </tbody>
            </table>
            <div>
                <p>※ 이용기간이 종료된 후에는 모든 직원이 비활성화됩니다.</p>
                <p>※ 이용기간이 종료된 후 재 결제를 원하시면, 컬래버랜드에 문의하셔야합니다.​</p>
            </div>
        <?php echo form_close(); ?>
        <?php
            ...
            <table class="table table-hover table-striped table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-sm-10 form-inline">
                            <?php echo number_format(element('company_deposit', element('data', $view))); ?>원
                            <a class="btn btn-default btn-sm" href="/admin/cinfo/company/deposit/<?php echo element(element('primary_key', $view), element('data', $view)); ?>" style="float: right;">예치금 사용 내역</a>
                        </td>
                    </tr>
                </tbody>
            </table>
