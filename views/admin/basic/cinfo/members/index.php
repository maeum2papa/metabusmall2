				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td><a href="/admin/counter/lmscounter/apply_mem_detail/<?php echo element(element('primary_key', $view), $result); ?>" class="btn btn-outline btn-default btn-xs">학습현황</a></td>
