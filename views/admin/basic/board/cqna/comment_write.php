<style>
	...
	.comment_write_box_inner{padding-bottom: 50px;}
</style>
...
<div id="comment_write_box">
	<div class="well comment_write_box_inner">
		...
		?>
			...
			?>
			<textarea class="input commenttextarea qna_comment" name="cmt_content" id="cmt_content" rows="5" accesskey="c"><?php echo set_value('cmt_content', element('cmt_content', element('comment', $view))); ?></textarea>
			...
			<div class="comment_write_button_area">
				<div class="form-group pull-left">
					<button type="button" class="btn btn-danger btn-sm" id="cmt_btn_submit" onclick="add_comment(this.form, '<?php echo element('post_id', element('post', $view)); ?>');">댓글등록</button>
				</div>
