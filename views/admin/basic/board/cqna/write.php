...
<?php //var_dump(element('board', $view)); ?>
<style>
		...
		<div class="writeform">
			<li style="display:flex;align-items: center;margin: 8px 0;">
				...
				<div style="display:table;">
					<input type="text" class="input px400" name="post_title" id="post_title" value="<?php echo '답변 드립니다.'; ?>" />
			...
			<div class="form-group mb20">
				...
				<?php echo display_dhtml_editor('post_content', set_value(''), $classname = 'dhtmleditor', $is_dhtml_editor = element('use_dhtml', element('board', $view)), $editor_type = $this->cbconfig->item('post_editor_type')); ?>
