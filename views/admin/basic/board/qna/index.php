				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td title="제목">
								<a href="/admin/board/qna/post/<?php echo element('post_id', $result);?>"><?php echo html_escape(element('post_title', $result)); ?></a>
							</td>
							<td title="이미지">
						...
						<?php foreach(element('list', element('comment_list', $result)) as $k => $v){ ?>
							<tr>
								...
								<td title="제목"><a href="/admin/board/qna/modify/<?php echo element('post_id', $v);?>"><?php echo html_escape(element('post_title', $v)); ?></a></td>
								<td title="이미지">
