			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo element('input', $value); ?></td>
					</tr>
					<?php
						}
					}
					...
					?>
					<tr>
						<th>링크 #<?php echo $i+1; ?></th>
						<td><input type="text" class="input px400" name="<?php echo $link_column; ?>" value="<?php echo set_value($link_column, $link); ?>" /></td>
					</tr>
					<?php
						}
					}
					...
					<tr>
						<th>설문 <a href="javascript:;" onClick="$('.post_poll_area').slideToggle('slow');">여기를 클릭하셔서 설문을 등록하실 수 있습니다</a></th>
						<td>
