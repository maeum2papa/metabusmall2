<div class="">
	<a href="./masterstatcnt" class="btn btn-outline btn-sm">전체</a>
...
<div class="flex-wrap">
	<div class="left">
		<h2>접속자 통계 그래프</h2>
		<a href="/admin/counter/masterstatcnt/users" class="btn btn-default">더보기</a>
		<div class="box">
	...
	<div class="right">
		<h2>기기별 그래프</h2>
		<a href="/admin/counter/masterstatcnt/devices" class="btn btn-default">더보기</a>
		<div class="box">
			<div class="box-table">
				<div class="box-table-header">
