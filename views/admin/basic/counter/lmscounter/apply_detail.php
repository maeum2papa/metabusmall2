...
<ul class="lmscounter-submenu btn-group">
	...
	<li><a href="/admin/counter/lmscounter/apply" class="btn btn-sm btn-default <?php if($url_arr[3] == 'apply_detail'){ echo 'btn-warning'; } ?>">학습 신청 통계</a></li>
