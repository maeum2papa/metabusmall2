    ...
    ?>
        ...
        <div class="box-table-header">
			<div class="input-group">
				...
				<select name="chgstate" id="chgstate">
                    ...
                    <option value="<?php echo element('template_idx', $v);?>"><?php echo element('template_name', $v);?></option>
                    <?php } ?>
				</select>
			</div>
		</div>
        ...
        <table class="table table-hover table-striped table-bordered">
            <tbody>
                <tr>
                    <th>템플릿 이름</th>
                    <td><input type="text" class="input px400" name="template_name" id="template_name" value=""></td>
                </tr>
                <tr>
                    <th>템플릿 설명</th>
                    <td>
                        <textarea class="smarteditor dhtmleditor" name="template_contents" id="template_contents" cols="10" rows="100"></textarea>
                    </td>
                </tr>
                <tr>
                    <th>템플릿 노출</th>
                    <td>
                        <div class="input-group">
                            <label for="showy" class="checkbox-inline"><input type="radio" name="template_showFl" value="y" id="showy">노출</label>
                            <label for="shown" class="checkbox-inline"><input type="radio" name="template_showFl" value="n" id="shown">미노출</label>
                            <label for="shows" class="checkbox-inline"><input type="radio" name="template_showFl" value="s" id="shows">특정기업 노출</label>
