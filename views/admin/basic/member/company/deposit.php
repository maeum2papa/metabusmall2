			...
			?>
				<div class="box-table-header">
					<div class="btn-group btn-group-sm" role="group">
						<a href="<?php echo admin_url('member/company/deposit'); ?>/<?php echo element('company_idx', $view); ?>" class="btn btn-sm <?php echo ( ! $this->input->get('type') && ! $this->input->get('type')) ? 'btn-success' : 'btn-default';?>">전체내역</a>
						<a href="<?php echo admin_url('member/company/deposit'); ?>/<?php echo element('company_idx', $view); ?>?type=1" class="btn btn-sm <?php echo ($this->input->get('type') == 1) ? 'btn-success' : 'btn-default';?>">충전내역</a>
						<a href="<?php echo admin_url('member/company/deposit'); ?>/<?php echo element('company_idx', $view); ?>?type=2" class="btn btn-sm <?php echo ($this->input->get('type') == 2) ? 'btn-success' : 'btn-default';?>">사용내역</a>
					</div>
				</div>
