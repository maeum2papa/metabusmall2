        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 form-inline">
                <select name="company_idx" id="company_idx" class="form-control">
                    ...
                    <?php  foreach($view['data']['company_list'] as $l) { echo "<option value='".$l['company_idx']."'>".$l['company_name']."</option>";}?>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="mem_div" value="<?php echo set_value('mem_div', element('mem_div', element('data', $view))); ?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">직책</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="mem_position" value="<?php echo set_value('mem_position', element('mem_position', element('data', $view))); ?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">상태</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="mem_state" value="<?php echo set_value('mem_state', element('mem_state', element('data', $view))); ?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">현재보유_씨앗</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="mem_cur_seed" value="<?php echo set_value('mem_cur_seed', element('mem_cur_seed', element('data', $view))); ?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">현재보유_열매</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="mem_cur_fruit" value="<?php echo set_value('mem_cur_fruit', element('mem_cur_fruit', element('data', $view))); ?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">랭킹</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="mem_ranking" value="<?php echo set_value('mem_ranking', element('mem_ranking', element('data', $view))); ?>" />
            </div>
        </div>
        <div class="form-group">
