		...
		?>
			...
			?>
				<div class="btn-group pull-right" role="group" aria-label="...">
					...
					<button type="button" class="btn btn-outline btn-default btn-sm btn-list-ex btn-list-selected disabled" data-list-ex-url = "<?php echo element('list_ex_url', $view); ?>" >선택비활성화</button>
					<button type="button" class="btn btn-outline btn-danger btn-sm btn-list-unex btn-list-selected disabled" data-list-unex-url = "<?php echo element('list_unex_url', $view); ?>" >선택활성화</button>
				</div>
			<?php
			...
			<div class="table-responsive">
				<table class="table table-hover table-striped table-bordered">
					<thead>
						<tr>
							<th style="width: 60px;"><input type="checkbox" name="chkall" id="chkall"></th>
							<th style="width: 70px;"><a href="<?php echo element('num', element('sort', $view)); ?>">번호</a></th>
							<th style="width: 120px;">썸네일</th>
							<th style="width: 150px;"><a href="<?php echo element('plan_idx', element('sort', $view)); ?>">플랜</a></th>
							<th>과정명</th>
							<th style="width: 150px;">활성화여부</th>
							<th style="width: 150px;">노출기간</th>
							<th style="width: 230px;">카테고리</th>
							<th>커리큘럼</th>
							<th style="width: 130px;">등록일</th>
							<!--<th style="width: 70px;">내용보기</th>-->
						</tr>
					</thead>
					<tbody>
					<?php
					...
					?>
						<tr>
                            ...
                            <!--<td><a href="<?php echo admin_url($this->pagedir); ?>/write/<?php echo element(element('primary_key', $view), $result); ?>?<?php echo $this->input->server('QUERY_STRING', null, ''); ?>" class="btn btn-outline btn-default btn-xs">보기</a></td>-->
						</tr>
					<?php
						}
					}
