	...
	<div class="box-table">
		...
		?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
                    <input type="text" class="form-control" name="p_subtitle" value="<?php echo set_value('p_subtitle', element('p_subtitle', element('data', $view))); ?>" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">필수/선택</label>
				<div class="col-sm-10 form-inline">
					<label class="radio-inline" for="p_essentialYn_n">
						<input type="radio" name="p_essentialYn" id="p_essentialYn_n" value="n" checked <?php echo set_radio('p_essentialYn', 'n', (element('p_essentialYn', element('data', $view)) == 'n' ? true : false)); ?>/> 선택
					</label>
					<label class="radio-inline" for="p_essentialYn_y">
						<input type="radio" name="p_essentialYn" id="p_essentialYn_y" value="y" <?php echo set_radio('p_essentialYn', 'y', (element('p_essentialYn', element('data', $view)) == 'y' ? true : false)); ?> /> 필수
					</label>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">추천여부</label>
				<div class="col-sm-10 form-inline">
					<label class="radio-inline" for="p_recommendYn_n">
						<input type="radio" name="p_recommendYn" id="p_recommendYn_n" value="n" checked <?php echo set_radio('p_recommendYn', 'n', (element('p_recommendYn', element('data', $view)) == 'n' ? true : false)); ?>/> 아니오
					</label>
					<label class="radio-inline" for="p_recommendYn_y">
						<input type="radio" name="p_recommendYn" id="p_recommendYn_y" value="y" <?php echo set_radio('p_recommendYn', 'y', (element('p_recommendYn', element('data', $view)) == 'y' ? true : false)); ?> /> 예
					</label>
				</div>
			</div>
			<div class="form-group">
