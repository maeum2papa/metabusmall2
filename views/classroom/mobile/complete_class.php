<div id="asmo_classroom">
	<div id="asmo_classroom_myClass">
		<div class="myClass_wrap">
			...
			<div class="myClass_board_bottom asmo_complete_class">
				<ul>
					<li class="asmo_table_tit">
						...
						<span class="asmo_table_tit_05"><b>결과</b></span>
						<span class="asmo_table_tit_06"><b></b></span>
					</li>
					<!-- 필수 강의 구분을 위해 selected 클래스 추가 -->
					<!-- 필수 강의 구분을 위해 complete 클래스 추가 -->
					<?php  
						if(count($view['data']['list'])>0){
							foreach($view['data']['list'] as $k=>$v){ 
					?>
					<li class="asmo_table_data">
						...
						<span class="asmo_table_tit_06"><a href="/classroom/cert_export/<?=$v[mp_sno]?>" class="asmo_certification">수료증 출력</a></span>
					</li>
					<?php
							}
						}else{
